            ...
            <div className='row-container-col'>
                <div className='row'>
                    <div className='note-container'>
                        ...
                        <button disabled={isEnabled && !isReplacing && !isInserting} className='btn-translate note-btn' onClick={() => onClickWholeRestNote()}>
                    ...
                    <div className='note-container'>
                        ...
                        <button disabled={isEnabled && !isReplacing && !isInserting} onClick={() => onClickHalfRestNote()}>
                ...
                <div className='row'>
                    <div className='note-container'>
                        ...
                        <button disabled={isEnabled && !isReplacing && !isInserting} onClick={() => onClickQuarterRestNote()}>
                    ...
                    <div className='note-container'>
                        ...
                        <button disabled={isEnabled && !isReplacing && !isInserting} onClick={() => onClickEighthRestNote()}>
                ...
                <div className='row'>
                    <div className='note-container'>
                        <h3 className='note-label'>Whole</h3>
                        <button disabled={isEnabled && !isReplacing && !isInserting} className='btn-translate note-btn' onClick={() => onClickDottedWholeRestNote()}>
                            <span id='WholeRest' className='note-menu-image'>&#119099;<span className='dot rest-dot'>.</span></span>
                        </button>
                    </div>
                    <div className='note-container'>
                        <h3 className='note-label'>Half</h3>
                        <button disabled={isEnabled && !isReplacing && !isInserting} onClick={() => onClickDottedeHalfRestNote()}>
                            <span id='HalfRest' className='note-menu-image'>&#119100;<span className='dot rest-dot'>.</span></span>
                        </button>
                    </div>
                    <div className='note-container'>
                        <h3 className='note-label'>Quarter</h3>
                        <button disabled={isEnabled && !isReplacing && !isInserting} onClick={() => onClickDottedQuarterRestNote()}>
