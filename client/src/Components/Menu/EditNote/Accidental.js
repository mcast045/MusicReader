...
const Accidental = () => {
    ...
    const preventAccidentalNotes = (key, idx) => {
        ...
        else if (key === 2) return notes[idx].letter !== 'F#'
        else if (key === 3) return notes[idx].letter !== 'C#' && notes[idx].letter !== 'F#'
        else if (key === 4) return notes[idx].letter !== 'G#' && notes[idx].letter !== 'C#' && notes[idx].letter !== 'F#'
        else if (key === 5) return notes[idx].letter !== 'D#' && notes[idx].letter !== 'G#' && notes[idx].letter !== 'C#' && notes[idx].letter !== 'F#'
        else if (key === 6) return notes[idx].letter !== 'A#' && notes[idx].letter !== 'D#' && notes[idx].letter !== 'G#' && notes[idx].letter !== 'C#' && notes[idx].letter !== 'F#'
        else if (key === 7) return notes[idx].letter !== 'F' && notes[idx].letter !== 'A#' && notes[idx].letter !== 'D#' && notes[idx].letter !== 'G#' && notes[idx].letter !== 'C#' && notes[idx].letter !== 'F#'

        else if (key === -1) return notes[idx].letter !== 'A#'
        else if (key === -2) return notes[idx].letter !== 'A#' && notes[idx].letter !== 'D#'
        else if (key === -3) return notes[idx].letter !== 'A#' && notes[idx].letter !== 'D#' && notes[idx].letter !== 'G#'
        else if (key === -4) return notes[idx].letter !== 'A#' && notes[idx].letter !== 'D#' && notes[idx].letter !== 'G#' && notes[idx].letter !== 'C#'
        else if (key === -5) return notes[idx].letter !== 'A#' && notes[idx].letter !== 'D#' && notes[idx].letter !== 'G#' && notes[idx].letter !== 'C#' && notes[idx].letter !== 'F#'
    }
    ...
    const accidentalChange = (e, kb, noteToEditIndex, key) => {
        if ((e.target.id === 'Sharp' || kb === 'Sharp') && (notes[noteToEditIndex].row > 1 || notes[noteToEditIndex].transform === 'move-down') && (preventAccidentalNotes(key.id, noteToEditIndex) || notes[noteToEditIndex].accidental === FLAT_NOTE) && notes[noteToEditIndex].accidental !== NATURAL_NOTE && isLetterSameLength(noteToEditIndex, 'Sharp') && (notes[noteToEditIndex].letter !== 'D#' && notes[noteToEditIndex].letter !== 'A#'))
            updateNoteLetter(notes[noteToEditIndex].row, noteToEditIndex, SHARP_NOTE, notes, key)
        else if ((e.target.id === 'Flat' || kb === 'Flat') && (notes[noteToEditIndex].row < 12 || notes[noteToEditIndex].transform === 'move-up') && (preventAccidentalNotes(key.id, noteToEditIndex) || notes[noteToEditIndex].accidental === SHARP_NOTE) && notes[noteToEditIndex].accidental !== NATURAL_NOTE && isLetterSameLength(noteToEditIndex, 'Flat') && (notes[noteToEditIndex].letter !== 'F#' && notes[noteToEditIndex].letter !== 'C#'))
            updateNoteLetter(notes[noteToEditIndex].row, noteToEditIndex, FLAT_NOTE, notes, key)
        else if ((e.target.id === 'Natural' || kb === 'Natural') && preventNaturalNotes(key.id, noteToEditIndex) && (notes[noteToEditIndex].accidental !== FLAT_NOTE && notes[noteToEditIndex].accidental !== SHARP_NOTE))
            updateNoteLetter(notes[noteToEditIndex].row, noteToEditIndex, NATURAL_NOTE, notes, key)
        else
    ...
    const accidentalNote = (e, kb) => {
        ...
        if (!isRestNote(noteToEditIndex, null, notes)) {
            if (key.id === 1) accidentalChange(e, kb, noteToEditIndex, key)
            else if (key.id === 2) accidentalChange(e, kb, noteToEditIndex, key)
            else if (key.id === 3) accidentalChange(e, kb, noteToEditIndex, key)
            else if (key.id === 4) accidentalChange(e, kb, noteToEditIndex, key)
            else if (key.id === 5) accidentalChange(e, kb, noteToEditIndex, key)
            else if (key.id === 6) accidentalChange(e, kb, noteToEditIndex, key)
            else if (key.id === 7) accidentalChange(e, kb, noteToEditIndex, key)

            else if (key.id === -1) accidentalChange(e, kb, noteToEditIndex, key)
            else if (key.id === -2) accidentalChange(e, kb, noteToEditIndex, key)
            else if (key.id === -3) accidentalChange(e, kb, noteToEditIndex, key)
            else if (key.id === -4) accidentalChange(e, kb, noteToEditIndex, key)
            else if (key.id === -5) accidentalChange(e, kb, noteToEditIndex, key)
        ...
        <div className='row-container-col-mod'>
            <div className='row'>
                <div className='note-container'>
                    ...
                    <button onClick={e => accidentalNote(e)} disabled={notes[editIndex(notes)] && notes[editIndex(notes)].accidental === SHARP_NOTE}>
            ...
            <div className='note-container'>
                ...
                <button onClick={e => accidentalNote(e)} disabled={notes[editIndex(notes)] && notes[editIndex(notes)].accidental === FLAT_NOTE}>
